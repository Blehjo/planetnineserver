...
namespace Planetnineserver.Controllers
{
    ...
    [ApiController]
    public class MooncommentController : ControllerBase
    {
        private readonly Planetnineservercontext _context;
        private readonly IWebHostEnvironment _hostEnvironment;

        public MooncommentController(Planetnineservercontext context, IWebHostEnvironment hostEnvironment)
        {
            _context = context;
        ...
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost("{id}")]
        public async Task<ActionResult<IEnumerable<MoonComment>>> PostComment(int id, [FromForm] MoonComment mooncomment)
        {
            if (_context.MoonComment == null)
            {
